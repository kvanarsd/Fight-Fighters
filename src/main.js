...
Polish/Style: I converted the fighter game into something more managable while creating more interactings with the characters. Turning the attacks into a conversation allows the players to get to know the characters and also implement the cut scenes that the show has. Convos will randomly start but will be cut short if the speaker is hurt.
